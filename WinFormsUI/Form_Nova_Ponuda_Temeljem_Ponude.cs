...
{
    public partial class Form_Nova_Ponuda_Temeljem_Ponude : Form
    {
        #region Varijable
        Form_Main main;
        string premaPonudiBroj = "";
        ...
        public Form_Nova_Ponuda_Temeljem_Ponude(string br, Form_Main f)
        {
            InitializeComponent();
        ...
        private void Form_Nova_Ponuda_Load(object sender, EventArgs e)
        {
            ...
            {
                if (ponuda.BrojPonude.ToString() == premaPonudiBroj)
                {
            ...
            {
                if (detalj.BrojPonude.ToString() == premaPonudiBroj)
                {
                    Card c2 = new Card();
